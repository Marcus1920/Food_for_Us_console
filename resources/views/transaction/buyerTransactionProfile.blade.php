        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="tile">
                    ...
                    <div class="listview narrow" id="buyerTransaction">
                        @foreach($buyerTransactionSide as $item)
                            <div class="media p-l-5" >
                                <div class="pull-left">
                                    <img src="{{$item->sellers->profilePicture}}" class="media-object" style="width:60px">
                                </div>
                                <div class="media-body">
                                    <span class="t-overflow" href="">{{strtoupper($item->sellers->name)}} {{strtoupper($item->sellers->surname)}} ( TRANSACTION ID {{$item->id}})</span><br>
