    ...
    <tr>
        <td align="center" style="border-collapse: collapse;">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                <tbody>
                <tr><td valign="top" class="m_-1793961898241284267mcnTextContent" style="color:#ffffff;font-family:Helvetica;font-size:11px;line-height:125%;padding:9px 18px;text-align:center" align="center">

                        <img src="{{ $message->embed(public_path('/img/FFU_Logo_Aqua_RGB.png')) }}" alt="log" height="80" width="120"/>
                    </td>
                </tr>
                </tbody>
            </table>
